...
/* harmony import */ var core_js_modules_es6_array_find_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57);
...
/* harmony import */ var core_js_modules_es6_promise__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
...
/* harmony import */ var core_js_modules_es6_object_create__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(77);
...
/* harmony import */ var core_js_modules_es6_reflect_construct__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(78);
...
/* harmony import */ var core_js_modules_es6_object_set_prototype_of__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80);
...
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(82);
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var core_js_modules_es6_string_iterator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(83);
...
/* harmony import */ var core_js_modules_es6_array_from__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(85);
...
/* harmony import */ var core_js_modules_es6_function_name__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(87);
...
/* harmony import */ var core_js_modules_es6_regexp_to_string__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(88);
...
/* harmony import */ var core_js_modules_es6_date_to_string__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(90);
...
/* harmony import */ var core_js_modules_es6_object_to_string__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(91);
...
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(92);
...
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(93);
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(94);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var core_js_modules_es6_array_is_array__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(98);
/* harmony import */ var core_js_modules_es6_array_is_array__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_is_array__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var core_js_modules_es6_object_define_property__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(99);
/* harmony import */ var core_js_modules_es6_object_define_property__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_object_define_property__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var core_js_modules_es6_array_map__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(100);
/* harmony import */ var core_js_modules_es6_array_map__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_map__WEBPACK_IMPORTED_MODULE_18__);
...
var Bez = function () {
  ...
  _createClass(Bez, [{
    key: "runBez",
    value: function runBez(cx1, cy1, cx2, cy2) {
      this.c1 = [cx1, cy1];
      this.c2 = [cx2, cy2];
    }
  }, {
    key: "line",
    value: function line() {
      this.run(this.oneBezier, this.p1, this.p2);
    }
  }, {
    key: "flat",
    value: function flat() {
      this.run(this.oneBezier, this.p1, this.p2, this.c1);
    }
  }, {
    key: "cubic",
    value: function cubic() {
      this.run(this.threeBezier, this.p1, this.p2, this.c1, this.c2);
    }
  }, {
    key: "pre",
    value: function pre(arr) {
    ...
    key: "run",
    value: function run(fun) {
      for (var _len = arguments.length, parat = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        parat[_key - 1] = arguments[_key];
      }

      for (var index = 0; index < 1; index += this.poin) {
        var coor = fun.apply(void 0, [index].concat(parat));
        this.poins.push(this.pre(coor));
      }
    }
  }, {
    key: "oneBezier",
    value: function oneBezier(t, p1, p2) {
    ...
    key: "twoBezier",
    value: function twoBezier(t, p1, p2, cp) {
    ...
    key: "threeBezier",
    value: function threeBezier(t, p1, p2, cp1, cp2) {
...
var Whell = function () {
  function Whell(_ref2) {
    var canvas = _ref2.canvas,
        canvasW = _ref2.canvasW,
        canvasH = _ref2.canvasH,
        bgc = _ref2.bgc,
        shrink = _ref2.shrink;

    _classCallCheck(this, Whell);
  ...
  _createClass(Whell, [{
    ...
    key: "MCW",
    value: function MCW(val) {
      return this.canvasW * val;
    }
  }, {
    key: "MCH",
    value: function MCH(val) {
      return this.canvasH * val;
    }
  }, {
    key: "CWAH",
    value: function CWAH(img, w) {
      var width = img.width,
          height = img.height;
    ...
    key: "recoTranslate",
    value: function recoTranslate() {
      this.ctx.translate(-this.ctrX, -this.ctrY);
    }
  }, {
    key: "drawRotateWheel",
    value: function drawRotateWheel(degree) {
      this.degSum += degree;
      this.degree = degree;
    ...
    key: "rotateDegree",
    value: function rotateDegree(deg) {
...
var Poin = function (_Whell) {
  _inherits(Poin, _Whell);

  var _super = _createSuper(Poin);

  function Poin(_ref3) {
    var _this;

    var canvas = _ref3.canvas,
        canvasW = _ref3.canvasW,
        canvasH = _ref3.canvasH,
        bgc = _ref3.bgc,
        poin = _ref3.poin,
        poinWidth = _ref3.poinWidth,
        poinX = _ref3.poinX,
        poinY = _ref3.poinY,
        poinDeg = _ref3.poinDeg,
        poinCenter = _ref3.poinCenter;

    _classCallCheck(this, Poin);
    ...
    _this.poin = poin;
    _this.poinDeg = poinDeg || 0;
    _this.pW = _this.poin.width;
    _this.pH = _this.poin.height;
    _this.poinWidth = poinWidth;
    _this.poinCenter = poinCenter;
    _this.poinHeight = _this.CWAH(_this.poin, _this.poinWidth);
    _this.poinX = poinX || -_this.poinWidth / 2;
    _this.poinY = poinY || _this.poinCenter ? -_this.poinHeight / 2 : (-_this.sHeight - _this.poinHeight * 0.3) / 2;
    _this.darwPoinDeg = poinDeg ? _this._darwPoinDeg : _this._darwPoinDegDef;
    return _this;
  }

  _createClass(Poin, [{
    key: "darwPointer",
    value: function darwPointer() {
      this.ctx.drawImage(this.poin, 0, 0, this.pW, this.pH, this.poinX, this.poinY, this.poinWidth, this.poinHeight);
    }
  }, {
    key: "_darwPoinDegDef",
    value: function _darwPoinDegDef() {
      this.darwPointer();
    }
  }, {
    key: "_darwPoinDeg",
    value: function _darwPoinDeg() {
...
var Fortune = function (_Poin) {
  _inherits(Fortune, _Poin);

  var _super2 = _createSuper(Fortune);

  function Fortune(_ref4) {
    var _this2;

    var _ref4$poinCenter = _ref4.poinCenter,
        poinCenter = _ref4$poinCenter === void 0 ? false : _ref4$poinCenter,
        coeDou = _ref4.coeDou,
        thre = _ref4.thre,
        poinNum = _ref4.poinNum,
        fps = _ref4.fps,
        prizeInfo = _ref4.prizeInfo,
        spinNum = _ref4.spinNum,
        canvas = _ref4.canvas,
        canvasW = _ref4.canvasW,
        canvasH = _ref4.canvasH,
        bgc = _ref4.bgc,
        poin = _ref4.poin,
        poinWidth = _ref4.poinWidth,
        poinX = _ref4.poinX,
        poinY = _ref4.poinY,
        poinDeg = _ref4.poinDeg,
        rate = _ref4.rate;
    ...
    _this2 = _super2.call(this, {
      ...
      poinY: poinY,
      poinDeg: poinDeg,
      poinCenter: poinCenter
    });
    _this2.rate = rate || 10;
    _this2.bezRate = _this2.rate;
    _this2.animInter = null;
    _this2.prizeInfo = prizeInfo;
    _this2.degMatIndex = null;
    _this2.spinNum = spinNum || 3;
    _this2.drawTime = fps ? parseInt(1000 / fps) : parseInt(1000 / 60);
    _this2.degNum = null;
    _this2.thre = thre || 5;
    _this2.prize = null;
    _this2.bezier = null;
    _this2.poinNum = poinNum || 100;
    _this2.step = 0;
    _this2.stepArr = [];
    _this2.stepIn = 1;
    _this2.prevStep = 0;
    _this2.coeDou = coeDou || 40;
    return _this2;
  }
  ...
  _createClass(Fortune, [{
    ...
    value: function start(index) {
      ...
      return new Promise(function (resolve, reject) {
        var prize = index !== undefined ? index : _this3.random(0, _this3.prizeInfo.length - 1);

        _this3.assignPrize(prize).then(resolve);
      });
    }
  }, {
    key: "bez",
    value: function bez() {
      var cx1 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.5;
      var cy1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.5;
      var cx2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.5;
      var cy2 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.5;
      this.bezier = new Bez({
        poin: this.poinNum,
        c1: [cx1, cy1],
        c2: [cx2, cy2]
    ...
    key: "assignPrize",
    value: function assignPrize(index) {
      var _this4 = this;

      return new Promise(function (resolve, reject) {
        _this4.degNum = _this4.handleDeg(index) + _this4.spinNum * _this4.circle + _this4.poinDeg;
        _this4.step = _this4.degNum / _this4.poinNum;
        _this4.stepArr = _this4.generateArray(0, _this4.poinNum - 1).map(function (num) {
          return parseInt(num * _this4.step);
        });
        _this4.animInter = setInterval(function () {
          if (_this4.degSum >= _this4.degNum) {
            resolve(_this4.end());
          }

          if (_this4.degSum >= _this4.stepArr[_this4.stepIn]) {
            _this4.rateBezier(_this4.stepIn);
    ...
    key: "generateArray",
    value: function generateArray(start, end) {
      return Array.from(new Array(end + 1).keys()).slice(start);
    }
  }, {
    key: "rateBezier",
    value: function rateBezier(index) {
      var _this$bezier$poins$in = _slicedToArray(this.bezier.poins[index], 2),
          x = _this$bezier$poins$in[0],
          y = _this$bezier$poins$in[1];

      var coeStep = y - this.prevStep;
      this.prevStep = y;
    ...
    key: "handleDeg",
    value: function handleDeg(index) {
      var tar = this.prizeInfo[index];
      var max = this.circle - tar.ds[1] + this.thre;
      var min = this.circle - tar.ds[0] - this.thre - this.rate;
      var random = this.random(max, min);
      return random;
    }
  }, {
    key: "degreeMatch",
    value: function degreeMatch() {
      var deg = this.circle - this.rotaDegr + this.poinDeg;
      var index = this.prizeInfo.findIndex(function (pr) {
        return deg > pr.ds[0] && deg <= pr.ds[1];
      });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(50).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(6) && /./g.flags != 'g') __webpack_require__(4).f(RegExp.prototype, 'flags', {
  configurable: true,
...
$export($export.P + $export.F * !__webpack_require__(101)([].map, true), 'Array', {
